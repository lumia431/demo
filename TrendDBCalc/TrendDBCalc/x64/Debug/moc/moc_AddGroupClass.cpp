...
void AddGroupClass::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        AddGroupClass *_t = static_cast<AddGroupClass *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (AddGroupClass::*_t)(QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AddGroupClass::OkSignal)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject AddGroupClass::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_AddGroupClass.data,
      qt_meta_data_AddGroupClass,  qt_static_metacall, nullptr, nullptr}
};
...
void *AddGroupClass::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AddGroupClass.stringdata0))
        return static_cast<void*>(const_cast< AddGroupClass*>(this));
