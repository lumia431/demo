...
void AddDBClass::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AddDBClass *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (AddDBClass::*)(QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AddDBClass::OkSignal)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject AddDBClass::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_AddDBClass.data,
    qt_meta_data_AddDBClass,
    qt_static_metacall,
    nullptr,
    nullptr
} };
